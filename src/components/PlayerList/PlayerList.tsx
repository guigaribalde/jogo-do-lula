  ...
  return (
    <>
      {width > 1200
        ...
        : (
          <>
            <div className="w-10 h-10 rounded bg-white flex justify-center items-center cursor-pointer text-[#FF2d74]" onClick={toggleOpen}>
              {players.length}
            </div>
            {
              isOpen && (
                <div className="absolute top-0 bottom-0 left-0 right-0 bg-stone-200 z-10 h-full">
                  <div className="p-5">
                    <span className="text-red-500 cursor-pointer" onClick={toggleOpen}>x</span>
                  </div>
